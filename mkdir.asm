...
main(int argc, char *argv[])
{
  ...
  2b:	ff 33                	pushl  (%ebx)
  2d:	e8 e8 02 00 00       	call   31a <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 390:	8a 92 3c 07 00 00    	mov    0x73c(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 55b:	e9 c9 fe ff ff       	jmp    429 <printf+0x45>
          s = "(null)";
 560:	bb 33 07 00 00       	mov    $0x733,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 584:	a1 68 0a 00 00       	mov    0xa68,%eax
 ...
 596:	73 10                	jae    5a8 <free+0x30>
{
 ...
 5bf:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5c1:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 5c6:	5b                   	pop    %ebx
 5c7:	5e                   	pop    %esi
 5c8:	5f                   	pop    %edi
 ...
 5ec:	89 10                	mov    %edx,(%eax)
  freep = p;
 5ee:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 5f3:	5b                   	pop    %ebx
 5f4:	5e                   	pop    %esi
 5f5:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 60a:	46                   	inc    %esi
  if((prevp = freep) == 0){
 60b:	8b 3d 68 0a 00 00    	mov    0xa68,%edi
 ...
 645:	8b 3d 68 0a 00 00    	mov    0xa68,%edi
 ...
 66e:	e8 05 ff ff ff       	call   578 <free>
  return freep;
 673:	a1 68 0a 00 00       	mov    0xa68,%eax
 ...
 69c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 69f:	a3 68 0a 00 00       	mov    %eax,0xa68
      return (void*)(p + 1);
 ...
 6ba:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 6bc:	c7 05 68 0a 00 00 6c 	movl   $0xa6c,0xa68
 6c3:	0a 00 00 
 6c6:	c7 05 6c 0a 00 00 6c 	movl   $0xa6c,0xa6c
 6cd:	0a 00 00 
    base.s.size = 0;
 6d0:	c7 05 70 0a 00 00 00 	movl   $0x0,0xa70
 6d7:	00 00 00 
 6da:	bf 6c 0a 00 00       	mov    $0xa6c,%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
